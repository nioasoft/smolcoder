...
export const STYLES = String.raw`
  :root {
    ...
    --heading: #eef3f5; --border-strong: #2c343a; --scrollbar: #2c343a; --scrollbar-hover: #3d474f;
    --hover-bg: #1a2023; --subtle-bg: #141a1d; --on-bg: #13202a; --active-bg: #17232a; --sess-active: #20292d;
    --primary-bg: #173f47; --primary-fg: #eef3f5; --primary-border: #1f5d68; --ghost-bg: #151b1e;
    --btn-bg: #1e2428; --input-bg: #14181b; --stop-border: #3d2d31; --status-hover: #293138;
    --sel-fg: #f2f7f8; --sel-dim: #c8dde2; --accent-ring: #35bfd433;
    --code-bg: #1b2124; --pre-bg: #11161a; --th-bg: #171d20; --result-bg: #0e1214; --tool-done: #b9c6c7;
    --bubble: #1b2125; --input-border: #354149; --input-focus: #55737b;
    --meter-track: #364047; --meter-fill: #7dabad; --panel-bg: #101416; --iframe-bg: #fff;
    --shadow: #0006; --shadow-soft: #0002; --term-bg: #0a0c0d;
    --ansi-black: #3b4048; --ansi-blue: #7aa2f7; --ansi-white: #c0caf5;
    --ansi-bright-red: #ff9e9e; --ansi-bright-green: #b9f27c; --ansi-bright-yellow: #ffd580;
    --ansi-bright-blue: #8db4ff; --ansi-bright-magenta: #d0b4ff; --ansi-bright-cyan: #74e0f0;
    --ansi-bright-white: #eef3f5;
    color-scheme: dark;
  }
  /* Light palette: GitHub-light neutrals; text colors stay >= 4.5:1 on --bg, --box, --hover-bg and --code-bg. */
  :root[data-theme="light"] {
    --bg: #ffffff; --fg: #1f2328; --dim: #57606a; --gray: #656d76;
    --accent: #08737f; --yellow: #8a5d00; --red: #cf222e; --green: #1a7336;
    --magenta: #7a45d6; --box: #f6f8fa; --sel: #0b6b75; --line: #d0d7de; --side: #f6f8fa;
    --heading: #1f2328; --border-strong: #c8d1da; --scrollbar: #c8d1da; --scrollbar-hover: #a8b1ba;
    --hover-bg: #eef1f4; --subtle-bg: #eef1f4; --on-bg: #ddf0f2; --active-bg: #ddf0f2; --sess-active: #e3e8ed;
    --primary-bg: #0b6b75; --primary-fg: #ffffff; --primary-border: #095a63; --ghost-bg: #f6f8fa;
    --btn-bg: #f6f8fa; --input-bg: #ffffff; --stop-border: #f0c2c6; --status-hover: #eaeef2;
    --sel-fg: #ffffff; --sel-dim: #d8eef1; --accent-ring: #08737f33;
    --code-bg: #eff1f3; --pre-bg: #f6f8fa; --th-bg: #f6f8fa; --result-bg: #f6f8fa; --tool-done: #424a53;
    --bubble: #f6f8fa; --input-border: #d0d7de; --input-focus: #6fa9b1;
    --meter-track: #d0d7de; --meter-fill: #2a8d96; --panel-bg: #f6f8fa; --iframe-bg: #fff;
    --shadow: #0003; --shadow-soft: #0001; --term-bg: #f6f8fa;
    --ansi-black: #24292f; --ansi-blue: #0550ae; --ansi-white: #57606a;
    --ansi-bright-red: #a40e26; --ansi-bright-green: #116329; --ansi-bright-yellow: #7d4e00;
    --ansi-bright-blue: #0969da; --ansi-bright-magenta: #6639ba; --ansi-bright-cyan: #0e6f7a;
    --ansi-bright-white: #1f2328;
    color-scheme: light;
  }
  ...
  * { scrollbar-width: thin; }
  ...
  .iconbtn:hover { color: var(--fg); border-color: var(--line); background: var(--hover-bg); }
  .iconbtn.on { color: var(--accent); border-color: var(--line); background: var(--on-bg); }
  .iconbtn svg { display: block; }
  .primary { background: var(--primary-bg); color: var(--primary-fg); border: 1px solid var(--primary-border); padding: 5px 12px; border-radius: 4px; cursor: pointer; }
  .primary:hover { border-color: var(--accent); }
  .ghost { background: var(--ghost-bg); color: var(--fg); border: 1px solid var(--line); border-radius: 4px; padding: 5px 10px; cursor: pointer; }
  ...
  .wshdr:hover { background: var(--subtle-bg); }
  ...
  .sess:hover { background: var(--subtle-bg); color: var(--fg); }
  .sess.active { background: var(--active-bg); color: var(--heading); }
  ...
  .wsbtn:hover { border-color: var(--line); background: var(--subtle-bg); }
  ...
  .ask button, .ask .opt { margin: 6px 8px 0 0; background: var(--btn-bg); color: var(--fg); border: 1px solid var(--border-strong); padding: 4px 12px; cursor: pointer; font: inherit; border-radius: 3px; }
  .ask button:hover, .ask .opt:hover { border-color: var(--accent); }
  .ask .opt.current { border-color: var(--green); }
  .ask .askinput { margin-top: 8px; width: min(420px, 100%); box-sizing: border-box; background: var(--input-bg); color: var(--fg); border: 1px solid var(--border-strong); padding: 6px 8px; font: inherit; border-radius: 3px; outline: none; }
  ...
  #jumpbottom { position: absolute; bottom: calc(100% + 8px); left: 50%; transform: translateX(-50%); z-index: 4; border-radius: 20px; padding: 6px 14px; white-space: nowrap; box-shadow: 0 4px 16px var(--shadow); font-size: 12px; }
  ...
  #menu .item.sel { background: var(--sel); color: var(--sel-fg); }
  #menu .item.sel .ds { color: var(--sel-dim); }
  ...
  #actionbtn { flex: none; background: var(--btn-bg); color: var(--dim); border: 1px solid var(--border-strong); padding: 3px 14px; cursor: pointer; font: inherit; font-size: 12px; border-radius: 3px; }
  #actionbtn:hover { border-color: var(--accent); color: var(--accent); }
  #actionbtn.stop { color: var(--red); border-color: var(--stop-border); }
  ...
  .ptab:hover { color: var(--fg); background: var(--subtle-bg); }
  .ptab.on { color: var(--heading); background: var(--active-bg); border-color: var(--line); }
  ...
  .tabbody.browser iframe { flex: 1; border: 0; background: var(--iframe-bg); width: 100%; min-height: 0; }
  ...
  .tabbody.term { background: var(--term-bg); }
  ...
  .a30 { color: var(--ansi-black); } .a31 { color: var(--red); } .a32 { color: var(--green); } .a33 { color: var(--yellow); }
  .a34 { color: var(--ansi-blue); } .a35 { color: var(--magenta); } .a36 { color: var(--accent); } .a37 { color: var(--ansi-white); }
  .a90 { color: var(--gray); } .a91 { color: var(--ansi-bright-red); } .a92 { color: var(--ansi-bright-green); } .a93 { color: var(--ansi-bright-yellow); }
  .a94 { color: var(--ansi-bright-blue); } .a95 { color: var(--ansi-bright-magenta); } .a96 { color: var(--ansi-bright-cyan); } .a97 { color: var(--ansi-bright-white); }
  ...
  .chip { background: var(--hover-bg); border: 1px solid var(--line); color: var(--dim); border-radius: 12px; padding: 1px 10px; font-size: 12px; cursor: pointer; }
  ...
  .fsitem:hover { background: var(--hover-bg); }
  ...
  .sess.active { background: var(--sess-active); }
  ...
  .user { border: 1px solid var(--line); border-radius: 10px; background: var(--bubble); padding: 14px 18px; margin: 24px 0; font-weight: 400; }
  .md { line-height: 1.8; }
  .md p { margin: 12px 0; }
  ...
  .tool.finished .name { color: var(--tool-done); }
  .tool.failed .name, .tool.failed summary::before { color: var(--red); }
  .result { margin: 4px 0 12px 16px; border: 1px solid var(--line); border-radius: 6px; background: var(--result-bg); padding: 12px; max-height: 280px; overflow: auto; white-space: pre-wrap; }
  ...
  #inputbox { border: 1px solid var(--input-border); border-radius: 12px; padding: 14px 16px 10px; background: var(--bubble); box-shadow: 0 8px 30px var(--shadow-soft); }
  #inputbox:focus-within { border-color: var(--input-focus); }
  ...
  .statusbtn:hover { background: var(--status-hover); color: var(--fg); }
  ...
  meter { width: 35px; height: 8px; appearance: none; border: none; background: var(--meter-track); border-radius: 9px; overflow: hidden; }
  meter::-webkit-meter-bar { background: var(--meter-track); border: none; }
  meter::-webkit-meter-optimum-value { background: var(--meter-fill); }
  meter::-moz-meter-bar { background: var(--meter-fill); }
  ...
  .attach { display: inline-flex; align-items: center; gap: 6px; max-width: 100%; border: 1px solid var(--line); border-radius: 8px; padding: 4px 6px 4px 8px; background: var(--subtle-bg); font-size: 12px; color: var(--fg); }
  ...
  #main.dragging #inputbox { border-color: var(--accent); box-shadow: 0 0 0 3px var(--accent-ring); }
  ...
  .user .filechip { display: inline-block; border: 1px solid var(--line); border-radius: 8px; padding: 4px 10px; font-size: 12px; color: var(--fg); text-decoration: none; background: var(--subtle-bg); }
